...
<html
  ...
  data-assets-path="{{ asset('admin_template/assets/') }}"
...
>
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('admin_template/assets/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('admin_template/assets/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset('admin_template/assets/css/demo.css') }}" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ asset('admin_template/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
